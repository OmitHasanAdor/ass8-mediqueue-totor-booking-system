  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10 items-end bg-gray-50 dark:bg-zinc-900 p-5 rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm">
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-sm font-semibold ">Search Tutor</label>
        <input
          type="text"
      ...
      <div>
        <button
          onClick={handleReset}
          className="w-full  hover:bg-gray-100  font-semibold p-2.5 rounded-xl border border-gray-200 transition-all text-sm active:scale-[0.99] shadow-sm"
        >
          Reset Filters
        </button>
      </div>
