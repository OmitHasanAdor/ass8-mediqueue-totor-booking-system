...
const TutorCard = ({ tutor }) => {
  ...
  return (
    <div className="max-w-md bg-white rounded-[2rem] shadow-xl overflow-hidden border border-gray-100 p-6 font-sans">
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2 mt-1 text-gray-500">
          <FaUniversity className="text-teal-600 shrink-0" />
      ...
      <div className="space-y-4 pt-1">
        ...
        <button 
          onClick={() => console.log(`Booking tutor ID: ${_id}`)}
          className="w-full bg-[#2a8375] hover:bg-[#20665b] text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 active:scale-[0.98] shadow-md shadow-teal-600/10"
        >
          Book Session
        </button>
      </div>
